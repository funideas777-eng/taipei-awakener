...
export const SKILLS = {
    ...
    'inferno': {
        ...
        effect: { type: 'damage', multiplier: 3.5, element: 'fire' },
    },
    ...
    'chain-lightning': {
        ...
        effect: { type: 'damage', multiplier: 3.0, element: 'thunder' },
    },
    ...
    'divine-judgment': {
        ...
        desc: '最強光屬性攻擊',
        effect: { type: 'damage', multiplier: 4.0, element: 'light' },
    },
...
export const MONSTER_SKILLS = {
    ...
    'tidal-wave': { name: '潮汐波', power: 2.0, element: 'water' },
    ...
    'chaos-wave': { name: '混沌波動', power: 2.5 },
    ...
    'toxic-storm': { name: '毒霧風暴', power: 2.5, status: 'poison' },
    ...
    'deep-crush': { name: '深海壓碎', power: 3.5 },
    'tsunami': { name: '海嘯', power: 4.0, element: 'water' },
